...
from aslxplane.flight_control.mpc_controller import MPCFlightController, DEFAULT_COST_CONFIG
...
def run_trial(
    ...
    controller = MPCFlightController(
        config={
            "sim_speed": sim_speed,
            "use_vision": use_vision,
            "vision_config": {"camera_id": 0, "model_path": MODEL_PATH, "device": "cpu"},
        },
        view=view,
    )
    hist_list, cost_list = [], []
